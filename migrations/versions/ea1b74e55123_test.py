...
def upgrade():
    ...
    op.create_table('settings',
                    ...
                    sa.Column('ldap_listen', sa.String(
                        length=40), nullable=True),
                    sa.Column('ldaps_enabled', sa.Boolean(), nullable=True),
                    sa.Column('ldaps_listen', sa.String(
                        length=40), nullable=True),
                    sa.Column('ldaps_cert', sa.String(
                        length=40), nullable=True),
                    sa.Column('ldaps_key', sa.String(
                        length=40), nullable=True),
    ...
    op.create_table('included_groups',
                    ...
                    sa.ForeignKeyConstraint(
                        ['include_id'], ['group.unixid'], ),
                    sa.ForeignKeyConstraint(
                        ['included_in_id'], ['group.unixid'], )
                    )
