...
def upgrade():
    ...
    with op.batch_alter_table('settings', schema=None) as batch_op:
        batch_op.add_column(
            sa.Column('groupformat', sa.String(length=4), nullable=True))
        batch_op.add_column(
            sa.Column('nameformat', sa.String(length=4), nullable=True))
        batch_op.add_column(
            sa.Column('sshkeyattr', sa.String(length=20), nullable=True))
